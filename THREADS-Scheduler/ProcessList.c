...
//  */
// void initializeProcessList(ProcessList s*usingProcessListPtr)
// {
...
//     usingProcessListPtr->headQuitProcessesPtr = NULL;
// }
...
//     else
//     {
//         // otherwise set the next pointer of the previous process to the next pointer of the current process to remove it
