...
gcc -Wall -c .\LinkedList.c -I ../../Include -o .\out\LinkedList.o

# Compile LinkedListsTest.c into an object file with warnings enabled, adding the Include directory
gcc -Wall -c .\LinkedListsTest.c -I ../../Include -o .\out\LinkedListsTest.o
