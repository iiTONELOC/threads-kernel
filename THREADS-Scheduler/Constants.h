...
#define STATUS_BLOCKED_IO 4
#define STATUS_QUIT 5
#define STATUS_USER_DEFINED 10
...
#define DEFAULT_TIME_SLICE_MS 45
#define NUM_MILLI_SEC_IN_MICRO_SEC 1000
#define MAX_PROC_QUANTUM (DEFAULT_TIME_SLICE_MS * NUM_MILLI_SEC_IN_MICRO_SEC)
#endif
