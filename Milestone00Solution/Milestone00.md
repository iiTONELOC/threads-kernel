# Scheduler Milestone (SchedulerTest00)
...
The `SchedulerTest00` test case is a simple case that creates one child process, waits for the process to terminate, and then exits.
...
All modified files have been provided with the submission and will need to be placed at the solution's root for a successful build, including the `Scheduler.vcxproj` file. Additionally, a zipped THREADS-Scheduler, `Milestone00Solution\THREADS-Scheduler-Milestone00-SolutionCAST.zip` has also been provided. It is pre-built and contains everything needed to be instantly executed from within `Visual Studio`.  

## Solution

The current approach for the Scheduler uses doubly linked lists and a priority-process queue for managing processes.  

The queue isn't really a queue, but it is an array of linked lists, indexed by state, i.e. Ready, Running, blocked, etc., with each list sorted by priority.

The process table, storage for linked list nodes, and the priority queue are all pre-allocated at compile-time to the stack.

Our solution, while it may be changed, currently implements linked lists as virtual lists, therefore a linked list node should only exist in one list at a time. Linked List Nodes for children processes are dynamically allocated when the child is created and destroyed when the child exits.

```c
Process processTable[MAX_PROCESSES];            
```

### Priority-Round-Robin Scheduling Model

```md
+-----------+
| 0 READY   | --> [ Priority 4 ] --> [ Priority 4 ] --> [ Priority 3 ] --> [ Priority 1 ]
+-----------+

+-----------+
| 1 RUNNING | --> [ Priority 4 ]
+-----------+

+-----------+
| 2 BLOCKED | --> [ Priority 4 ] --> [ Priority 3 ] --> [ Priority 3 ]
+-----------+
...
|------------------|--------------------------------------|
| 00               | <p style="color: green"> PASSED </p> |
| 01               | <p style="color: green"> PASSED </p> |
| 02               | <p style="color: green"> PASSED </p> |
| 03               | <p style="color: green"> PASSED </p> |
| 04               | <p style="color: red"> FAILED </p>   |
| 05               | <p style="color: green"> PASSED </p> |
| 06               | <p style="color: red"> FAILED </p>   |
| 07               | <p style="color: green"> PASSED </p> |
| 08               | <p style="color: green"> PASSED </p> |
| 09               | <p style="color: green"> PASSED </p> |
| 10               | <p style="color: red"> FAILED </p>   |
| 11               | <p style="color: red"> FAILED </p>   |
| 12               | <p style="color: red"> FAILED </p>   |
| 13               | <p style="color: red"> FAILED </p>   |
| 14               | <p style="color: red"> FAILED </p>   |
| 15               | <p style="color: red"> FAILED </p>   |
| 16               | <p style="color: green"> PASSED </p> |
| 17               | <p style="color: red"> FAILED </p>   |
| 18               | <p style="color: green"> PASSED </p> |
| 19               | <p style="color: red"> FAILED </p>   |
| 20               | <p style="color: red"> FAILED </p>   |
| 21               | <p style="color: red"> FAILED </p>   |
| 22               | <p style="color: red"> FAILED </p>   |
| 23               | <p style="color: red"> FAILED </p>   |
| 24               | <p style="color: red"> FAILED </p>   |
| 25               | <p style="color: green"> PASSED </p> |
| 26               | <p style="color: red"> FAILED </p>   |
| 27               | <p style="color: red"> FAILED </p>   |
| 28               | <p style="color: red"> FAILED </p>   |
| 29               | <p style="color: green"> PASSED </p> |
| 30               | <p style="color: green"> PASSED </p> |
| 31               | <p style="color: red"> PASSED </p>   |
...
SchedulerTest04: after spawn of child 51
SchedulerTest04: after spawn of child 52
...
1       -1       0          READY         0        0        watchdog
2       -1       5          RUNNING       48       0        Scheduler
51      2        3          READY         0        0        SchedulerTest04-Child49
52      2        3          READY         0        0        SchedulerTest04-Child50
53      2        3          READY         0        0        SchedulerTest04-Child51
54      2        3          READY         0        0        SchedulerTest04-Child52
55      2        3          READY         0        0        SchedulerTest04-Child53
56      2        3          READY         0        0        SchedulerTest04-Child54
57      2        3          READY         0        0        SchedulerTest04-Child55
58      2        3          READY         0        0        SchedulerTest04-Child56
59      2        3          READY         0        0        SchedulerTest04-Child57
60      2        3          READY         0        0        SchedulerTest04-Child58
61      2        3          READY         0        0        SchedulerTest04-Child59
62      2        3          READY         0        0        SchedulerTest04-Child60
63      2        3          READY         0        0        SchedulerTest04-Child61
64      2        3          READY         0        0        SchedulerTest04-Child62
65      2        3          READY         0        0        SchedulerTest04-Child63
66      2        3          READY         0        0        SchedulerTest04-Child64
67      2        3          READY         0        0        SchedulerTest04-Child65
68      2        3          READY         0        0        SchedulerTest04-Child66
69      2        3          READY         0        0        SchedulerTest04-Child67
70      2        3          READY         0        0        SchedulerTest04-Child68
71      2        3          READY         0        0        SchedulerTest04-Child69
72      2        3          READY         0        0        SchedulerTest04-Child70
73      2        3          READY         0        0        SchedulerTest04-Child71
74      2        3          READY         0        0        SchedulerTest04-Child72
75      2        3          READY         0        0        SchedulerTest04-Child73
76      2        3          READY         0        0        SchedulerTest04-Child74
77      2        3          READY         0        0        SchedulerTest04-Child75
78      2        3          READY         0        0        SchedulerTest04-Child76
79      2        3          READY         0        0        SchedulerTest04-Child77
80      2        3          READY         0        0        SchedulerTest04-Child78
81      2        3          READY         0        0        SchedulerTest04-Child79
82      2        3          READY         0        0        SchedulerTest04-Child80
83      2        3          READY         0        0        SchedulerTest04-Child81
84      2        3          READY         0        0        SchedulerTest04-Child82
85      2        3          READY         0        0        SchedulerTest04-Child83
86      2        3          READY         0        0        SchedulerTest04-Child84
87      2        3          READY         0        0        SchedulerTest04-Child85
88      2        3          READY         0        0        SchedulerTest04-Child86
89      2        3          READY         0        0        SchedulerTest04-Child87
90      2        3          READY         0        0        SchedulerTest04-Child88
91      2        3          READY         0        0        SchedulerTest04-Child89
92      2        3          READY         0        0        SchedulerTest04-Child90
93      2        3          READY         0        0        SchedulerTest04-Child91
94      2        3          READY         0        0        SchedulerTest04-Child92
95      2        3          READY         0        0        SchedulerTest04-Child93
96      2        3          READY         0        0        SchedulerTest04-Child94
97      2        3          READY         0        0        SchedulerTest04-Child95
98      2        3          READY         0        0        SchedulerTest04-Child96

SchedulerTest04-Child49: started
SchedulerTest04-Child49: quitting
SchedulerTest04: exit status for child 51 is -3
SchedulerTest04-Child50: started
SchedulerTest04-Child50: quitting
SchedulerTest04: exit status for child 52 is -3
...
PID     Parent   Priority  Status         # Kids   CPUtime  Name
1       -1       0          READY         0        0        watchdog
2       -1       5          WAIT BLOCK    4        0        Scheduler
3       2        3          READY         0        968      SchedulerTest05-Child1
4       2        3          READY         0        961      SchedulerTest05-Child2
5       2        3          READY         0        966      SchedulerTest05-Child3
6       2        3          RUNNING       0        928      SchedulerTest05-Child4

PID     Parent   Priority  Status         # Kids   CPUtime  Name
1       -1       0          READY         0        0        watchdog
2       -1       5          WAIT BLOCK    4        0        Scheduler
3       2        3          READY         0        2806     SchedulerTest05-Child1
4       2        3          READY         0        2806     SchedulerTest05-Child2
5       2        3          READY         0        2816     SchedulerTest05-Child3
6       2        3          RUNNING       0        2775     SchedulerTest05-Child4
...
1       -1       0          READY         0        0        watchdog
2       -1       5          WAIT BLOCK    4        0        Scheduler
7       2        3          READY         0        951      SchedulerTest05-Child5
8       2        3          READY         0        967      SchedulerTest05-Child6
9       2        3          READY         0        971      SchedulerTest05-Child7
10      2        3          RUNNING       0        918      SchedulerTest05-Child8

PID     Parent   Priority  Status         # Kids   CPUtime  Name
1       -1       0          READY         0        0        watchdog
2       -1       5          WAIT BLOCK    4        0        Scheduler
7       2        3          READY         0        2783     SchedulerTest05-Child5
8       2        3          READY         0        2812     SchedulerTest05-Child6
9       2        3          READY         0        2819     SchedulerTest05-Child7
10      2        3          RUNNING       0        2759     SchedulerTest05-Child8
...
1       -1       0          READY         0        0        watchdog
2       -1       5          WAIT BLOCK    4        0        Scheduler
11      2        3          READY         0        961      SchedulerTest05-Child9
12      2        3          READY         0        965      SchedulerTest05-Child10
13      2        3          READY         0        969      SchedulerTest05-Child11
14      2        3          RUNNING       0        926      SchedulerTest05-Child12

PID     Parent   Priority  Status         # Kids   CPUtime  Name
1       -1       0          READY         0        0        watchdog
2       -1       5          WAIT BLOCK    4        0        Scheduler
11      2        3          READY         0        2803     SchedulerTest05-Child9
12      2        3          READY         0        2812     SchedulerTest05-Child10
13      2        3          READY         0        2808     SchedulerTest05-Child11
14      2        3          RUNNING       0        2773     SchedulerTest05-Child12
...
SchedulerTest06-Child1: after joining first child, status = -858993460
PID     Parent   Priority  Status         # Kids   CPUtime  Name
1       -1       0          READY         0        0        watchdog
2       -1       5          WAIT BLOCK    1        0        Scheduler
3       2        3          RUNNING       2        0        SchedulerTest06-Child1
...
SchedulerTest06-Child1: after joining second child, status = -858993460
PID     Parent   Priority  Status         # Kids   CPUtime  Name
1       -1       0          READY         0        0        watchdog
2       -1       5          WAIT BLOCK    1        0        Scheduler
3       2        3          RUNNING       2        0        SchedulerTest06-Child1
...
SchedulerTest06-Child1-Child1-Child1: exit status for child -5 is 255
k_exit(): Error: Process has children!
...
SchedulerTest10-Child1: finished joining parent process
SchedulerTest10: exit status for child 3 is -3
All processes completed.

SchedulerTest11: started
SchedulerTest11: after spawn of child with pid 3
SchedulerTest11: waiting for child process
SchedulerTest11-Child1: started
SchedulerTest11-Child1: quitting
SchedulerTest11: exit status for child 3 is -3
All processes completed.
...
SchedulerTest13-Child2: after joining child, pid 5, status = -858993460
...
SchedulerTest14-Child2: after joining child, pid 3, status = -858993460
...
SchedulerTest14-Child1: exit status for child 5 is -3
...
SchedulerTest15-Child1: after joining child, pid 5, status = 255
SchedulerTest15-Child1: waiting for 5
SchedulerTest15-Child2: started
SchedulerTest15-Child2: joining 5
SchedulerTest15-Child2: after joining child, pid 5, status = -858993460
...
1       -1       0          READY         0        0        watchdog
2       -1       5          WAIT BLOCK    1        0        Scheduler
3       2        4          WAIT BLOCK    1        0        SchedulerTest15-Child1
...
spawn(): No empty slots in the process table.
spawn(): No empty slots in the process table.
spawn(): No empty slots in the process table.
spawn(): No empty slots in the process table.
...
SchedulerTest20-Child1: k_join returned 0
SchedulerTest20: exit status for child 3 is -2
All processes completed.

SchedulerTest21: started
spawn(): Priority is out of range.
spawn(): Priority is out of range.
...
1       -1       0          READY         0        0        watchdog
2       -1       5          WAIT BLOCK    1        0        Scheduler
3       2        2          RUNNING       0        0        SchedulerTest22-Child1
4       3        3          QUIT          0        0        SchedulerTest22-Child1-Child1
5       3        3          QUIT          0        0        SchedulerTest22-Child1-Child2
6       3        3          QUIT          0        0        SchedulerTest22-Child1-Child3
...
1       -1       0          READY         0        0        watchdog
2       -1       5          WAIT BLOCK    1        0        Scheduler
3       2        2          RUNNING       0        0        SchedulerTest23-Child1
4       3        3          QUIT          0        0        SchedulerTest23-Child1-Child1
5       3        3          QUIT          0        0        SchedulerTest23-Child1-Child2
6       3        3          QUIT          0        0        SchedulerTest23-Child1-Child3
7       3        3          QUIT          0        0        SchedulerTest23-Child1-Child4
8       3        4          QUIT          0        0        SchedulerTest23-Child1-Child5
9       3        4          QUIT          0        0        SchedulerTest23-Child1-Child6
10      3        4          QUIT          0        0        SchedulerTest23-Child1-Child7
11      3        4          QUIT          0        0        SchedulerTest23-Child1-Child8
...
1       -1       0          READY         0        0        watchdog
2       -1       5          WAIT BLOCK    1        0        Scheduler
3       2        2          RUNNING       0        0        SchedulerTest24-Child1
4       3        4          QUIT          0        0        SchedulerTest24-Child1-Child1
5       3        4          QUIT          0        0        SchedulerTest24-Child1-Child2
6       3        4          QUIT          0        0        SchedulerTest24-Child1-Child3
7       3        4          QUIT          0        0        SchedulerTest24-Child1-Child4
8       3        3          QUIT          0        0        SchedulerTest24-Child1-Child5
9       3        3          QUIT          0        0        SchedulerTest24-Child1-Child6
10      3        3          QUIT          0        0        SchedulerTest24-Child1-Child7
11      3        3          QUIT          0        0        SchedulerTest24-Child1-Child8
...
SchedulerTest26-Child2: k_join for pid 3 returned 0 with status 255
SchedulerTest26: exit status for child 4 is -2
All processes completed.
...
SchedulerTest27-Child2: k_join for pid 5 returned 0 with status 255
...
SchedulerTest28-Child2: k_join for pid 5 returned 0 with status 255
...
3       2        3          READY         0        780      SchedulerTest29-Child1
4       2        3          READY         0        786      SchedulerTest29-Child2
5       2        3          READY         0        784      SchedulerTest29-Child3
6       2        3          RUNNING       0        733      SchedulerTest29-Child4
7       2        3          READY         0        742      SchedulerTest29-Child5

PID     Parent   Priority  Status         # Kids   CPUtime  Name
1       -1       0          READY         0        0        watchdog
2       -1       5          WAIT BLOCK    5        0        Scheduler
3       2        3          READY         0        2264     SchedulerTest29-Child1
4       2        3          READY         0        2262     SchedulerTest29-Child2
5       2        3          READY         0        2267     SchedulerTest29-Child3
6       2        3          RUNNING       0        2226     SchedulerTest29-Child4
7       2        3          READY         0        2232     SchedulerTest29-Child5
...
1       -1       0          READY         0        0        watchdog
2       -1       5          WAIT BLOCK    5        0        Scheduler
3       2        3          READY         0        3847     SchedulerTest29-Child1
8       2        3          READY         0        786      SchedulerTest29-Child6
9       2        3          READY         0        784      SchedulerTest29-Child7
10      2        3          RUNNING       0        740      SchedulerTest29-Child8
11      2        3          READY         0        734      SchedulerTest29-Child9

PID     Parent   Priority  Status         # Kids   CPUtime  Name
1       -1       0          READY         0        0        watchdog
2       -1       5          WAIT BLOCK    5        0        Scheduler
3       2        3          READY         0        5337     SchedulerTest29-Child1
8       2        3          READY         0        2261     SchedulerTest29-Child6
9       2        3          READY         0        2258     SchedulerTest29-Child7
10      2        3          RUNNING       0        2216     SchedulerTest29-Child8
11      2        3          READY         0        2213     SchedulerTest29-Child9
...
1       -1       0          READY         0        0        watchdog
2       -1       5          WAIT BLOCK    5        0        Scheduler
3       2        3          READY         0        6909     SchedulerTest29-Child1
12      2        3          READY         0        788      SchedulerTest29-Child10
13      2        3          READY         0        789      SchedulerTest29-Child11
14      2        3          RUNNING       0        738      SchedulerTest29-Child12
15      2        3          READY         0        739      SchedulerTest29-Child13

PID     Parent   Priority  Status         # Kids   CPUtime  Name
1       -1       0          READY         0        0        watchdog
2       -1       5          WAIT BLOCK    5        0        Scheduler
3       2        3          READY         0        8386     SchedulerTest29-Child1
12      2        3          READY         0        2265     SchedulerTest29-Child10
13      2        3          READY         0        2260     SchedulerTest29-Child11
14      2        3          RUNNING       0        2217     SchedulerTest29-Child12
15      2        3          READY         0        2211     SchedulerTest29-Child13
